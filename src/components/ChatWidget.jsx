...
function ChatWidget() {
  ...
  return (
    <>
      ...
      {/* Chat panel */}
      {open && (
        <div className="fixed bottom-24 right-6 w-80 h-96 bg-white rounded-xl shadow-2xl flex flex-col z-50 border">
          <div className="bg-blue-600 text-white px-4 py-3 rounded-t-xl">
            <h3 className="font-semibold text-sm">CryptoX Assistant</h3>
            <p className="text-xs text-blue-100">Ask about crypto prices & more</p>
          </div>
